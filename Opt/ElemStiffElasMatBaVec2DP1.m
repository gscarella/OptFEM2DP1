function [Kg]=ElemStiffElasMatBaVec2DP1(q,me,areas,lambda,mu)
% function [Kg]=ElemStiffElasMatBaVec2DP1(q,me,areas,lambda,mu)
...
G3=G3.*coef;
clear coef
Kg=zeros(36,size(me,2));
Kg(1,:)=(lambda + 2.*mu).*G1(1,:).^2 + mu.*G1(2,:).^2;
Kg(2,:)=lambda.*G1(1,:).*G1(2,:) + mu.*G1(1,:).*G1(2,:);
Kg(3,:)=(lambda + 2.*mu).*G1(1,:).*G2(1,:) + mu.*G1(2,:).*G2(2,:);
Kg(4,:)=lambda.*G1(1,:).*G2(2,:) + mu.*G1(2,:).*G2(1,:);
Kg(5,:)=(lambda + 2.*mu).*G1(1,:).*G3(1,:) + mu.*G1(2,:).*G3(2,:);
Kg(6,:)=lambda.*G1(1,:).*G3(2,:) + mu.*G1(2,:).*G3(1,:);
Kg(8,:)=(lambda + 2.*mu).*G1(2,:).^2 + mu.*G1(1,:).^2;
Kg(9,:)=lambda.*G1(2,:).*G2(1,:) + mu.*G1(1,:).*G2(2,:);
Kg(10,:)=(lambda + 2.*mu).*G1(2,:).*G2(2,:) + mu.*G1(1,:).*G2(1,:);
Kg(11,:)=lambda.*G1(2,:).*G3(1,:) + mu.*G1(1,:).*G3(2,:);
Kg(12,:)=(lambda + 2.*mu).*G1(2,:).*G3(2,:) + mu.*G1(1,:).*G3(1,:);
Kg(15,:)=(lambda + 2.*mu).*G2(1,:).^2 + mu.*G2(2,:).^2;
Kg(16,:)=lambda.*G2(1,:).*G2(2,:) + mu.*G2(1,:).*G2(2,:);
Kg(17,:)=(lambda + 2.*mu).*G2(1,:).*G3(1,:) + mu.*G2(2,:).*G3(2,:);
Kg(18,:)=lambda.*G2(1,:).*G3(2,:) + mu.*G2(2,:).*G3(1,:);
Kg(22,:)=(lambda + 2.*mu).*G2(2,:).^2 + mu.*G2(1,:).^2;
Kg(23,:)=lambda.*G2(2,:).*G3(1,:) + mu.*G2(1,:).*G3(2,:);
Kg(24,:)=(lambda + 2.*mu).*G2(2,:).*G3(2,:) + mu.*G2(1,:).*G3(1,:);
Kg(29,:)=(lambda + 2.*mu).*G3(1,:).^2 + mu.*G3(2,:).^2;
Kg(30,:)=lambda.*G3(1,:).*G3(2,:) + mu.*G3(1,:).*G3(2,:);
